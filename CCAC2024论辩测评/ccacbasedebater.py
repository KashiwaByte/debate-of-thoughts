...
class CCACBaseDebater(AbDebater):
    ...
    def invoke(self,message,round):
        if self.language == 'zh':
            if round == 1:
                ...
                context = message
                Prompt3 = f"""请站在正方的立场，总结双方之前的环节信息输出一个结辩稿，结辩不需要使用搜索工具，以下是之前的环节信息{context}"""
            ...
            if round == 1:
                ...
                EN_Prompt1 = f"""
                                ...
                                ///The topic is {topic}, your square is square///
                ...
                context = message
                EN_Prompt3 = f"""Please stand on the side of the affirmative, summarize the previous link information of both parties and output a closing draft. There is no need to use search tools for the closing argument. The following is the previous link information {context}"""

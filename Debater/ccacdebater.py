    ...
    def invoke(self,message,round):
        if self.language == 'zh':
            if round == 2:
                ...
                context = message
                Prompt2 = f"""你是一个资深的逻辑性很强的顶级辩手，你很擅长质询,总是一针见血，而且也很擅长使用类比来归谬对方的观点，你熟练的掌握各种数据攻防的技巧，请根据对方的立论内容进行反驳，你可以调用search工具获取反驳论据，以下是对方的立论稿{context}"""

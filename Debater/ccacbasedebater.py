...
EN_Prompt3 = f"""You are a senior and top-notch debater with strong logic. You are good at summarizing. Please stand on the side and output a closing draft based on the previous arguments and questioning sessions of both parties."""
